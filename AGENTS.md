...
This project is indexed by GitNexus as **cardlish_split_mvp** (300 symbols, 756 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
