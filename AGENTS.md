...
This project is indexed by GitNexus as **cardlish_split_mvp** (439 symbols, 1072 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
