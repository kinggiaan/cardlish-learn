...
This project is indexed by GitNexus as **cardlish_split_mvp** (352 symbols, 839 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
